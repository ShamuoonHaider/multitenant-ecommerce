...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g., Shamuoon's Store)
   */
  name: string;
  /**
...
export interface Product {
  ...
  image?: (string | null) | Media;
  refundPolicy?: ('30-day' | '14-day' | '7-day' | '3-day' | 'no-refund') | null;
  /**
...
export interface Order {
  ...
  /**
   * Stripe checkout session is associated with this order
   */
